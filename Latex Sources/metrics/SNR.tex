...
%---------------------------------------------------------
% signal-to-Noise Ratio (SNR): Introduction & efinition
\begin{frame}
...
%---------------------------------------------------------
% Visualizing SNR & Interpretation
\begin{frame}
    \frametitle{SNR: Visualizing Leakage \& Interpretation}
    \begin{center}
        % Placeholder for the image of a trace
        % Replace 'placeholder_trace_image.png' with your actual image file path
        % For example: \includegraphics[width=0.8\textwidth]{path/to/your/image_file.png}
        \includegraphics[width=0.8\textwidth]{superscalar/Pictures/cortexA7.png}
        \captionof{figure}{Example of a side-channel trace (placeholder image)}
    \end{center}
\end{frame}
\begin{frame}
...
%---------------------------------------------------------
%  SNR with Simulated Leakage: Scenario
\begin{frame}
