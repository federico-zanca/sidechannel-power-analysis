...
% Slide: Deductive Approach: CPI Analysis
\begin{frame}
...
% Slide: Introducing the Target CPU: ARM Cortex-A7 MPCore
\begin{frame}
    ...
    \begin{block}{CPU Overview}
        \begin{itemize}
            ...
            %\item Used in the Allwinner A20 System-on-Chip (SoC) for characterization.
        \end{itemize}
    \end{block}
...
% Slide: ARM Cortex-A7 pipeline logical view
\begin{frame}
...
%---------------------------------------------------------
% Slide: key microarchitectural discoveries (Cortex-A7 Example)
\begin{frame}
...
%---------------------------------------------------------
% Slide: alleged ARM Cortex-A7 pipeline structure
\begin{frame}
...
%---------------------------------------------------------
% Slide: instruction Pairs Executed in Dual-Issue
\begin{frame}
